 document.addEventListener('DOMContentLoaded', function () {
     Highcharts.getJSON('https://preco-operadoras.pt/back/api/prices', function (data) {
         ...
         $('#value-meo').html((data.meo[data.meo.length - 1][1]).toFixed(2) + "€");
         $('#value-vodafone').html((data.vodafone[data.vodafone.length - 1][1]).toFixed(2) + "€");
         $('#value-nos').html((data.nos[data.nos.length - 1][1]).toFixed(2) + "€");
